...
def urldownload_progressbar(url, filepath):
    ...
    size = 0 
    chunk_size = 32768 # 原值：1024；1Gbps建议chunk_size设置为262144-524288,最大利用带宽；100Mbps网络,建议chunk_size设置为32768-65536,最大利用带宽；10Mbps网络,建议chunk_size设置为8192-16384,最大利用带宽.
